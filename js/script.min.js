...
$(".down-here").click(function(){$("html,body").animate({scrollTop:$(".concept-statement").offset().top+100},e),$(".down-here").hide()}),setInterval(function(){$(".down-here").fadeTo("fast",.3),$(".down-here").fadeTo("fast",1)},1e3),$("h1").animate({color:"#ffffff"},e),$("h3").animate({color:"#ffffff"},e),$("header").animate({backgroundColor:"#131314"},0),$(".concept-statement").waypoint(function(a){"up"==a?($("h1").animate({color:"#ffffff"},{duration:e,queue:!1}),$("body").animate({backgroundColor:"#131314"},{duration:e,queue:!1}),$("h3").animate({color:"#ffffff"},{duration:e,queue:!1}),$("header").animate({backgroundColor:"#131314"},{duration:e,queue:!1}),$(".down-here").show()):"down"==a&&($("h1").animate({color:"#131314"},{duration:e,queue:!1}),$("body").animate({backgroundColor:"#ffffff"},{duration:e,queue:!1}),$("h3").animate({color:"#131314"},{duration:e,queue:!1}),$("header").animate({backgroundColor:"#ffffff"},{duration:e,queue:!1}),$(".down-here").hide())},{offset:function(){return 0}}),/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&$("#kickass").hide(),/(Mac|iPhone|iPod|iPad)/i.test(navigator.userAgent)||$("head").append("<link href='https://fonts.googleapis.com/css?family=Muli:300' rel='stylesheet' type='text/css'>"),$(".freelance-proj-email-button").click(function(){emailSampleHandler()}),$(".freelance-proj-email-field").keydown(function(e){13==e.keyCode&&emailSampleHandler()}),setInterval(changeQuote,1e4)}).scroll(function(){if($(this).scrollTop()>=$("#projects").position().top&&!booksAdded){var e=$("#reading-list")
