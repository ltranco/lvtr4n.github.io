...
$(document).ready(function() { 
    ...
    if($(this).scrollTop() >= $("#projects").position().top && !booksAdded){
        ...
        books.append("<div class=\"book\"><img class=\"\" src=\"img/books/long_tran_apple_carnegie.jpg\"/><h5>How to Win Friends &amp; Influence People</h5><h6>Dale Carnegie</h6><p>Currently reading this piece.</p></div>");
