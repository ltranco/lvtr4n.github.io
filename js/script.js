...
$(document).ready(function() { 
    ...
    if($(this).scrollTop() >= $("#projects").position().top && !booksAdded){
        ...
        books.append("<div class=\"book\"><img src=\"img/books/long_tran_apple_covey.jpeg\"/><h5>The 7 Habits of Highly Effective People</h5><h6>Stephen Covey</h6><p>Currently reading.</p></div>");
