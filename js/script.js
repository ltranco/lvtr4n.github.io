...
$(document).ready(function() { 
    ...
    if($(this).scrollTop() >= $("#projects").position().top && !booksAdded){
        ...
        books.append("<div class=\"book\"><img src=\"img/books/long_tran_apple_tzu.jpg\"/><h5>The Art of War</h5><h6>Sun Tzu</h6><p>Currently reading</p></div>");
